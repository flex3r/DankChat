...
fun View.showErrorDialog(throwable: Throwable) {
    ...
    MaterialAlertDialogBuilder(context)
        ...
        .setPositiveButton(R.string.error_dialog_copy) { d, _ ->
            ContextCompat.getSystemService(context, ClipboardManager::class.java)?.setPrimaryClip(android.content.ClipData.newPlainText("error stacktrace", stacktrace))
